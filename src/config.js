const config = {
    ...
    users: {
        ownerId: '601719195612348426', // The bot owner ID, which is you.
        developers: ['601719195612348426', '681854326238740491'] // The bot developers, remember to include your account ID with the other account IDs.
    },
