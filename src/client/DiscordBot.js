    ...
    constructor() {
        super({
            intents: [
                ...
                GatewayIntentBits.MessageContent, // Cho phép đọc nội dung tin nhắn
                GatewayIntentBits.GuildMembers,   // Cho phép đọc thông tin thành viên
                GatewayIntentBits.GuildMessageReactions, // (Tuỳ chọn) Nếu cần bắt sự kiện phản ứng
                GatewayIntentBits.GuildModeration // (Tuỳ chọn) Hỗ trợ tính năng kiểm duyệt
            ],
            partials: [
                Partials.Channel,
